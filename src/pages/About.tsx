        ...
        <section className="about">
            <div className="about-container">
                ...
                <div className="about-details">
                    <p>
                        Navigating the complexities of the Indian legal system requires more than just knowledge of the law—it demands strategy, empathy, and dedicated advocacy. <span className="font-bookman">With <strong>years of extensive experience</strong> practicing across various courts and tribunals in India, we provide robust legal representation and strategic counsel tailored to your unique situation.</span>
                    </p>
                    <p>
